    ...
    <>
            ...
            <form className="w-full" onSubmit={(e) => e.preventDefault()}>
              ...
              <AnimateIn delay={0.5}>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    type="submit"
                    className="w-full px-4 py-3.5 bg-accent-400 hover:bg-accent-500 text-white font-bold transition-colors duration-200 focus:outline-none shadow-md text-base tracking-[0.15em] uppercase"
                  >
                    SUBMIT
                  </button>
                </div>
      ...
      <section className="hidden lg:block relative w-full h-screen min-h-[700px] overflow-hidden">
        ...
        <nav className="relative z-20 w-full">
          ...
          <AnimateIn delay={0} className="absolute left-16 xl:left-20 top-4 z-30">
            <Link to="/" className="block">
              <img src={logoImage} alt="Campaign Logo" className="h-24 xl:h-28 w-auto" />
            </Link>
          </AnimateIn>
          ...
          <div className="flex items-center justify-end px-16 xl:px-20 pt-12 pb-5">
            ...
            <div className="flex items-center gap-5 xl:gap-7">
              ...
              <AnimateIn delay={0.05 * (navLinks.length + 1)}>
                <a
                  href={siteData.campaign.donateUrl}
                  className="bg-accent-400 hover:bg-accent-500 text-white font-bold px-7 xl:px-8 py-2.5 xl:py-3 rounded transition-colors duration-200 shadow-lg text-xs xl:text-sm tracking-[0.15em] uppercase ml-2"
                >
                  DONATE
                </a>
              </AnimateIn>
        ...
        {/* ===== HERO CONTENT ===== */}
        <div className="relative z-10 flex flex-col px-28 xl:px-36 pt-[11rem] xl:pt-[12rem]">
            ...
            <form className="w-full max-w-xl" onSubmit={(e) => e.preventDefault()}>
              ...
              <AnimateIn delay={0.5}>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button
                    type="submit"
                    className="w-full px-5 py-[18px] bg-accent-400 hover:bg-accent-500 text-white font-bold transition-colors duration-200 focus:outline-none shadow-md text-xl tracking-[0.15em] uppercase"
                  >
                    SUBMIT
                  </button>
                </div>
