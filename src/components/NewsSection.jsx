  ...
  return (
    <AnimateIn delay={delay}>
      <Link
        ...
        className="group block h-full rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-1"
        style={{
          backgroundColor: colors.white,
          border: `1px solid ${colors.neutral[200]}`,
        }}
        onMouseEnter={(e) => { e.currentTarget.style.borderColor = colors.accent[400] }}
      ...
      >
        ...
        <div className="px-6 py-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span
              className="inline-block text-[11px] font-bold tracking-[0.15em] uppercase px-2.5 py-1 rounded bg-accent-50"
              style={{
          ...
          <h3
            className="text-lg font-bold leading-snug mb-3 transition-colors duration-200 group-hover:opacity-80 text-primary-950"
          >
            {article.title}
          </h3>

          <p className="text-sm leading-relaxed text-neutral-600 mb-4 line-clamp-3">
            {article.excerpt}
          </p>
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <TextAnimate
          ...
          delay={0.15}
          once
          className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-12 md:mb-16 leading-tight tracking-tight text-primary-950"
        >
        ...
        <AnimateIn delay={0.5}>
          <div className="text-center mt-12 md:mt-16">
            <Link
              to="/news"
              className="inline-flex items-center gap-2 bg-accent-400 hover:bg-accent-500 text-white font-bold px-8 py-3.5 rounded transition-colors duration-200 shadow-lg text-sm tracking-[0.15em] uppercase"
            >
              View All News
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
