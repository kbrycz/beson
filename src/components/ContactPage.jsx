        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          <div className="max-w-2xl mx-auto">
            {submitted ? (
              <AnimateIn delay={0.1}>
                <div
                  className="text-center py-16 px-8 rounded-xl border border-neutral-200"
                ...
                >
                  ...
                  <button
                    ...
                    className="font-bold px-8 py-3 transition-all duration-200 uppercase tracking-[0.15em] text-sm shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <AnimateIn delay={0.2}>
                    <input
                      ...
                      className="contact-input w-full px-5 py-4 text-primary-950 font-semibold border-2 border-neutral-200 rounded-md focus:outline-none focus:border-accent-400 transition-all text-lg bg-white"
                      required
                    />
                  </AnimateIn>
                ...
                <AnimateIn delay={0.4}>
                  <textarea
                    ...
                    rows={6}
                    className="contact-input w-full px-5 py-4 text-primary-950 font-semibold border-2 border-neutral-200 rounded-md focus:outline-none focus:border-accent-400 transition-all text-lg bg-white resize-none"
                    required
                  />
                </AnimateIn>
